...
if args.is_training:
    for ii in range(args.itr):
        ...
        for i in range(1):
            ...
            np.savetxt(f'metrics_run_{i}_{args.model}_{args.pred_len}.csv', metrics, delimiter=',')
            np.savetxt(f'preds_run_{i}_{args.model}_{args.pred_len}.csv', preds, delimiter=',')
            np.savetxt(f'trues_run_{i}_{args.model}_{args.pred_len}.csv', trues, delimiter=',')
        ...
        with open('mean_std_metrics_{args.model}_{args.pred_len}.csv', 'w', newline='') as csvfile:
