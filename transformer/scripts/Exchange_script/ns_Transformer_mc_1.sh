...
python -u "/content/drive/MyDrive/masters back up/Nonstationary-Transfomers/Nonstationary_Transformers-main/Nonstationary_Transformers-main/MCDROPOUT_run.py" \
  --is_training 1 \
  --root_path "/content/drive/MyDrive/masters back up/Nonstationary-Transfomers/dataset/dataset/exchange_rate" \
  --data_path exchange_rate.csv \
  --model_id Exchange_96_5 \
